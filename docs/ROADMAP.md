...
>
> 状态复核（2026-08-29 第二次）：核心双路径与运营控制台均已完成；App 侧 AI
> 润色/短诗采纳（采纳制，服务端不自动补诗）与读信/导出叙事计数已收口，
> P0 规格对齐待办清零。下一步是音乐/标签/皮肤、账号升级和完整离线写作等 P1 项。
...
- [x] P0：写信页接入 AI 润色与短诗，保持用户可选采纳；AI 关闭时继续走纯手动流程
- [x] P0：读信页与导出图展示短诗，并补齐读/互动/回信叙事计数
